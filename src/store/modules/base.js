...
const INTIALIZE_LOGIN_MODAL = 'base/INTIALIZE_LOGIN_MODAL';
...
export const intializeLoginModal = createAction(INTIALIZE_LOGIN_MODAL);
...
export default handleActions({
    ...
    [INTIALIZE_LOGIN_MODAL]: (state, action) => {
        // 로그인 모달의 상태를 초기 상태로 설정 (텍스트/오류 초기화)
        return state.set('loginModal', intialState.get('loginModal'));
    },
